...
tags:
  ...
  - ota
  - uart
description: Designing a custom PCB with OTA support and a dual-image bootloader
---
...
![CustomBoot-32 schematic, part 1](/assets/posts/CustomBoot-32/sch1.png)

![CustomBoot-32 schematic, part 2](/assets/posts/CustomBoot-32/sch2.png)
...
### UART
UART communication between ESP and STM is the second important target after OTA in our project. Initially, we tried to establish communication between ESP and STM, but it did not work. So we tested the UART interfaces of ESP and STM individually using a **loopback test**.
Then we established duplex UART communication between both boards. All the code is provided below:
...
### Simple Bootloader
Before creating the final bootloader, we tested a simple bootloader that checks the **state of the PA0 pin** and accordingly switches between two applications residing at two different starting addresses.
Refer to [this repository](https://github.com/avm1234567/Customboot-32/tree/varun/Dual_Image_Bootloader) for the full code and test applications. Make sure you read the applications' vector offsets and flash them to their respective start addresses.
...
[Watch the perfboard test](https://drive.google.com/file/d/1SP9IA6iG8lHjdz1XjbkrW86w_i9Vo2Ad/view?usp=sharing)
...
![Front view of the CustomBoot-32 PCB](/assets/posts/CustomBoot-32/PCBSC1.png)

![Back view of the CustomBoot-32 PCB](/assets/posts/CustomBoot-32/PCBSC2.png)

*Front and back views of the routed PCB*

[Watch the full working demo](https://drive.google.com/file/d/1Z0VfDI0KjEA28zM6vQ-hMSaG2jekwzWR/view)

## References

[Reference project](https://github.com/SurajSonawane2415/USB-OTA-Bootloader-Integrated-Custom-STM-Board)

[Bootloader](https://embeddedinventor.com/embedded-bootloader-and-booting-process-explained/)

[OTA](https://docs.espressif.com/projects/esp-idf/en/stable/esp32/api-reference/system/esp_https_ota.html)

[STM32](https://www.youtube.com/watch?si=apB8K7ngO-cd8fAq&v=EaZuKRSvwdo&feature=youtu.be)
