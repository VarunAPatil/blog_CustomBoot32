...
<figure style="width: 600px; margin: auto;">
  <video controls width="600" preload="metadata" poster="/assets/posts/CustomBoot-32/Website_rec_poster.png">
    <source src="/assets/posts/CustomBoot-32/PerfboardTest.mp4" type="video/mp4">
...
Another major step in preparing our PCB for fabrication was **routing the board** and **generating the Gerber files.**  
>>>>>>> b59b4a1 (CustomBoot-32 blog)
...
<<<<<<< HEAD
<div style="border: 2px solid rgb(242, 71, 132); padding: 10px; width: fit-content; margin: 10px auto; border-radius: 6px; text-align: center;">
  <p><strong>Full working demo:</strong></p>
  <a href="https://drive.google.com/file/d/1Z0VfDI0KjEA28zM6vQ-hMSaG2jekwzWR/view">DEMO</a>
</div>
